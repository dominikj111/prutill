...
exports.getRaceWonPromise = exports.raceBuilder = exports.getLastPromise = exports.stackBuilder = void 0;
/**
 ...
 */
function stackBuilder(resolveAllPrevious = true) {
 ...
 */
function getLastPromise(key, promise, resolveAllPrevious = true) {
 ...
 * @returns A single stack function wrapper.
 */
function raceBuilder(resolveAllOthers = true) {
    let storedResolveCallbacks = [];
    let resolving = false;
    return promise => {
 ...
 * @returns A single stack function wrapper by unique key
 */
function getRaceWonPromise(key, promise, resolveAllOthers = true) {
...
exports.getRaceWonPromise = getRaceWonPromise;
